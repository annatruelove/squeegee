...
const JobPage = () => {
    ...
    function readJobData () {
        app.database().ref('jobs/').once('value')
    ...
    const SearchItem = (props) => {
        return (
            <div id="search-item">
                ...
                <div id="search-text">
                    <a id="job-link" href='/results'><h1>{props.title}</h1></a>
                    <h5>{props.salary}</h5>
                </div>
            </div>
        )
    ...
    return (
        ...
        <SearchItem src={data_analyst} title="Data Scientist" company="GitHub" salary="$85,000" gender="male" location="San Francisco, California" age="23"></SearchItem>
        </div>
        </>
